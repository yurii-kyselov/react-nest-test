...
import { ChangePost, CreatePost } from './Types';

interface ModalProps {
  header: string;
  handleModal: ((id: string, newPost: ChangePost) => void) | undefined;
  closeModal: () => void;
  id: string;
  post: ChangePost;
}
...
export default function PostChangeModal({ handleModal, header, closeModal, post, id }: ModalProps) {
  const [postPart, setPostPart] = React.useState<PostPart>({
